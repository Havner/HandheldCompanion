...
namespace HandheldCompanion.Models
{
    internal class ModelZDOPlus : IModel
    {
        ...
        Model3DGroup MainBodyRubberLeft;
        Model3DGroup MainBodyRubberRight;
        Model3DGroup FunctionButton1;
        Model3DGroup FunctionButton2;
        Model3DGroup FunctionButton3;
        Model3DGroup FunctionButton4;
        Model3DGroup Logo;
        Model3DGroup HomeButton;
        Model3DGroup LED1;
        Model3DGroup LED2;
        Model3DGroup LED3;
        Model3DGroup LED4;
        Model3DGroup LeftK;
        Model3DGroup RightK;
        Model3DGroup Paddle1;
        Model3DGroup Paddle2;
        Model3DGroup Paddle3;
        Model3DGroup Paddle4;
        Model3DGroup Paddle5;
        Model3DGroup Paddle6;
        Model3DGroup JoystickLeftLEDRing;
        Model3DGroup JoystickLeftCover;
        Model3DGroup JoystickRightLEDRing;
