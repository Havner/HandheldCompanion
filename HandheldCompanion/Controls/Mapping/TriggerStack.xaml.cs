...
namespace HandheldCompanion.Controls
{
    ...
    /// </summary>
    public partial class TriggerStack : SimpleStackPanel
    {
        ...
        public TriggerStack() : base()
        {
            InitializeComponent();
        }

        public TriggerStack(AxisLayoutFlags axis) : this()
        {
            this.axis = axis;
            ...
            AddMappingToChildren(new TriggerMapping(axis));
        }
        ...
        private TriggerMapping getMapping(int index)
        {
            return getGrid(index).Children[1] as TriggerMapping;
        }
        ...
        public void SetActions(List<IActions> actions)
        {
            ...
            foreach (var action in actions)
            {
                ...
                {
                    TriggerMapping mapping = new(axis);
        ...
        private void ButtonMapping_Updated(AxisLayoutFlags button)
        {
        ...
        private void AddMappingToChildren(TriggerMapping mapping)
        {
            ...
            mapping.Updated += (sender, action) => ButtonMapping_Updated((AxisLayoutFlags)sender);
            mapping.Deleted += (sender) => ButtonMapping_Updated((AxisLayoutFlags)sender);
