...
namespace HandheldCompanion.Controls
{
    ...
    /// </summary>
    public partial class AxisStack : SimpleStackPanel
    {
        ...
        public AxisStack() : base()
        {
            InitializeComponent();
        }

        public AxisStack(AxisLayoutFlags axis) : this()
        {
            this.axis = axis;
            ...
            AddMappingToChildren(new AxisMapping(axis));
        }
        ...
        private AxisMapping getMapping(int index)
        {
            return getGrid(index).Children[1] as AxisMapping;
        }
        ...
        private void AddMappingToChildren(AxisMapping mapping)
        {
